...
- (void)commonInit
{
	...
	_handleImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"analog_handle"]];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	{
		[self.delegate analogStickDidChangeValue:self];
	}
}
