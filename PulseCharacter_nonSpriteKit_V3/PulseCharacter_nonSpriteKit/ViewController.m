...
-(void) lvl1Load{
        ...
        // Load images
        NSArray *imageNames = @[@"lvl1Surfer1.png",@"lvl1Surfer2.png",@"lvl1Surfer3.png",@"lvl1Surfer4.png"];
        ...
        // Normal Animation
        UIImageView *animationImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 150, self.view.frame.size.width, self.view.frame.size.height)];
...
-(void) lvl2Load{
    ...
    // Load images
    NSArray *imageNames = @[@"lvl2Surfer1.png",@"lvl2Surfer2.png", @"lvl2Surfer3.png", @"lvl2Surfer4.png"];
...
-(void) lvl3Load{
    ...
    // Load images
    NSArray *imageNames = @[@"lvl3Surfer1.png",@"lvl3Surfer2.png",@"lvl3Surfer3.png",@"lvl3Surfer4.png"];
...
-(void) lvl4Load{
    ...
    // Load images
    NSArray *imageNames = @[@"lvl4Surfer1.png",@"lvl4Surfer2.png",@"lvl4Surfer3.png",@"lvl4Surfer4.png"];
